...
public class ParameterizeInputPort extends InputPort
{
        ...
        public static ParameterizeInputPort create( String name, VariablePath portInfoPath,
                        Expression expr, Interface iface,
                        jolie.process.Process configurationProcess,
                        Map< String, AggregatedOperation > aggregationMap,
                        Map< String, OutputPort > redirectionMap )
        {
                VariablePath locationPath = new VariablePathBuilder( false ).add( "location", 0 )
                                .toVariablePath();
                VariablePath protocolPath = new VariablePathBuilder( false ).add( "protocol", 0 )
                                .toVariablePath();

                return new ParameterizeInputPort( name, locationPath, protocolPath, iface,
                                aggregationMap, redirectionMap, portInfoPath, expr,
        ...
        public URI location()
        {
                return URI.create( this.portInfoPath.getValue().getChildren( "location" ).first()
                                .strValue() );
        }
        ...
        private ParameterizeInputPort( String name, VariablePath locationVariablePath,
                        ...
                        Map< String, AggregatedOperation > aggregationMap,
                        Map< String, OutputPort > redirectionMap, VariablePath portInfoPath,
                        Expression expr, jolie.process.Process configurationProcess )
        {
