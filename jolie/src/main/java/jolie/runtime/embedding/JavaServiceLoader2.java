...
public class JavaServiceLoader2 extends EmbeddedServiceLoader
{
	...
	public JavaServiceLoader2( Expression channelDest, String servicePath,
			Interpreter parentInterpreter, ServiceNode serviceNode, Type acceptedType )
			throws EmbeddedServiceLoaderCreationException
	{
		...
		final JolieClassLoader cl = parentInterpreter.getClassLoader();
		try {
