...
public class ProvideUntilStatement extends OLSyntaxNode
{
	...
	public int hashCode()
	{
		...
		result = prime * result + ((provide == null) ? 0 : provide.hashCode());
	...
	public boolean equals( Object obj )
	{
		...
		ProvideUntilStatement other = (ProvideUntilStatement) obj;
		if ( provide == null ) {
			if ( other.provide != null ) return false;
		} else if ( !provide.equals( other.provide ) ) return false;
		if ( until == null ) {
