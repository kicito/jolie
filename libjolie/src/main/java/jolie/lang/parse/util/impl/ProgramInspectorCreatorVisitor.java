...
public class ProgramInspectorCreatorVisitor implements OLVisitor
{
	...
	public void visit( DefinitionNode n ) {
		List< DefinitionNode> list = procedureDefinitions.get( n.context().source() );
		if ( list == null ) {
			list = new LinkedList< >();
			procedureDefinitions.put( n.context().source(), list );
		}
		list.add( n );
		encounteredNode(n);
		n.body().accept( this );
	...
	public void visit( ServiceNode n ) {
		List< ServiceNode> list = this.services.get( n.context().source() );
		if ( list == null ) {
			list = new LinkedList< >();
			this.services.put( n.context().source(), list );
		}
		list.add( n );
		encounteredNode(n);
	}
