...
public final class ServiceDef extends jolie.runtime.embedding.java.TypedStructure {
	...
	public ServiceDef( joliex.meta.spec.types.Location textLocation,
		...
		this.inputPorts =
			jolie.runtime.embedding.java.util.ValueManager.validated( "inputPorts", inputPorts, 0, 2147483647, t -> t );
	}
	...
	public java.util.List< joliex.meta.spec.types.OutputPort > outputPorts() {
		return outputPorts;
	}
	...
	public java.util.List< joliex.meta.spec.types.InputPort > inputPorts() {
		return inputPorts;
	}
	...
	public static jolie.runtime.embedding.java.util.StructureListBuilder< ServiceDef, Builder > listBuilder() {
		return new jolie.runtime.embedding.java.util.StructureListBuilder<>( ServiceDef::builder );
	}

	public static jolie.runtime.embedding.java.util.StructureListBuilder< ServiceDef, Builder > listBuilder(
		java.util.SequencedCollection< ? extends jolie.runtime.embedding.java.JolieValue > from ) {
		return from != null
			? new jolie.runtime.embedding.java.util.StructureListBuilder<>( from, ServiceDef::from,
				ServiceDef::builder )
			: listBuilder();
	}

	public static ServiceDef from( jolie.runtime.embedding.java.JolieValue j )
		...
		return new ServiceDef(
			...
			jolie.runtime.embedding.java.util.ValueManager.fieldFrom(
				j.getChildOrDefault( "outputPorts", java.util.List.of() ), joliex.meta.spec.types.OutputPort::from ),
			jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getFirstChild( "name" ),
				joliex.meta.spec.types.LocatedString::from ),
			jolie.runtime.embedding.java.util.ValueManager.fieldFrom(
				j.getChildOrDefault( "inputPorts", java.util.List.of() ), joliex.meta.spec.types.InputPort::from ) );
	}
	...
	public static ServiceDef fromValue( jolie.runtime.Value v ) throws jolie.runtime.typing.TypeCheckingException {
		...
		return new ServiceDef(
			...
			jolie.runtime.embedding.java.util.ValueManager.vectorFieldFrom( v, "outputPorts",
				joliex.meta.spec.types.OutputPort::fromValue ),
			jolie.runtime.embedding.java.util.ValueManager.singleFieldFrom( v, "name",
				joliex.meta.spec.types.LocatedString::fromValue ),
			jolie.runtime.embedding.java.util.ValueManager.vectorFieldFrom( v, "inputPorts",
				joliex.meta.spec.types.InputPort::fromValue ) );
	}
	...
	public static jolie.runtime.Value toValue( ServiceDef t ) {
		...
		t.outputPorts()
			.forEach( c -> v.getNewChild( "outputPorts" ).deepCopy( joliex.meta.spec.types.OutputPort.toValue( c ) ) );
		v.getFirstChild( "name" ).deepCopy( joliex.meta.spec.types.LocatedString.toValue( t.name() ) );
		t.inputPorts()
			.forEach( c -> v.getNewChild( "inputPorts" ).deepCopy( joliex.meta.spec.types.InputPort.toValue( c ) ) );
	...
	public static class Builder {
		...
		private Builder( jolie.runtime.embedding.java.JolieValue j ) {
			...
			this.name = jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getFirstChild( "name" ),
				joliex.meta.spec.types.LocatedString::from );
			this.inputPorts = jolie.runtime.embedding.java.util.ValueManager.fieldFrom(
				j.getChildOrDefault( "inputPorts", java.util.List.of() ), joliex.meta.spec.types.InputPort::from );
		}
		...
		public Builder outputPorts( java.util.SequencedCollection< joliex.meta.spec.types.OutputPort > outputPorts ) {
			this.outputPorts = outputPorts;
			return this;
		}

		public Builder outputPorts(
			java.util.function.Function< jolie.runtime.embedding.java.util.StructureListBuilder< joliex.meta.spec.types.OutputPort, joliex.meta.spec.types.OutputPort.Builder >, java.util.List< joliex.meta.spec.types.OutputPort > > f ) {
			return outputPorts( f.apply( new jolie.runtime.embedding.java.util.StructureListBuilder<>(
		...
		public Builder inputPorts( java.util.SequencedCollection< joliex.meta.spec.types.InputPort > inputPorts ) {
			this.inputPorts = inputPorts;
			return this;
		}

		public Builder inputPorts(
			java.util.function.Function< jolie.runtime.embedding.java.util.StructureListBuilder< joliex.meta.spec.types.InputPort, joliex.meta.spec.types.InputPort.Builder >, java.util.List< joliex.meta.spec.types.InputPort > > f ) {
			return inputPorts( f.apply( new jolie.runtime.embedding.java.util.StructureListBuilder<>(
